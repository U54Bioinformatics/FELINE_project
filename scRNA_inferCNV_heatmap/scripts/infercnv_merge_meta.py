...
def read_file_pd(infile):
    ...
    header  = ['Cell.ID', 'orig.ident', 'Sample', 'hpca_main_type', 'Encode_main_type', 'Infercnv_CNA']
...
def main():
    ...
    filetypes = ['_10x_cell_metadata.UMAPcluster.SingleR_anno_cluster.revised_anno.infercnv_tumor_normal.txt']
    for ft in filetypes:
