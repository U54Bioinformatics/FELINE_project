...
if (TRUE){
    ...
    #cell type -> color
    c <- data.frame(
            Cell.Type = c("Cancer cells", "Normal epithelial cells", "Stromal cells", "Immune cells", "Unclassified"),
            Color = c("#E7298A", "#66A61E", "#006633", "light sea green", "gray")
    )
    c1 <- data.frame(
    ...
    level_order <- c("Cancer cells", "Normal epithelial cells", "Stromal cells", "Immune cells", "Unclassified")
