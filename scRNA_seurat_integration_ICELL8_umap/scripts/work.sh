...
echo "prepare input"
cp ../Seurat_test_icell8/FEL001010_icell8_anno.filtered.counts.seurat_standard.rds ./
...
# seurat obj
#ln -s ../scRNA_seurat_integration_ICELL8/output/FEL001010_icell8_Seurat_2kgenes_vst_cc.integrated_RPCA.rds ./
#ln -s FEL001010_icell8_Seurat_2kgenes_vst_cc.integrated_RPCA.rds FEL001010_integrated_RPCA_icell8_Seurat_2kgenes_vst_cc.rds
...
ln -s FEL001010.cell_metadata.txt FEL001010_integrated_RPCA_10x.broadclass.metadata.txt
