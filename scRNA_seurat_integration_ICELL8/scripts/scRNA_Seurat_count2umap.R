...
counts.df <- fread(paste(prefix, "txt", sep="."), sep="\t", nThread=1)
...
#DimPlot(pbmc, reduction = "tsne", group.by = "RNA_snn_res.0.5", label=TRUE, pt.size = 1)
#DimPlot(pbmc, reduction = "tsne", group.by = "RNA_snn_res.0.8", label=TRUE, pt.size = 1)
#DimPlot(pbmc, reduction = "tsne", group.by = "RNA_snn_res.1.2", label=TRUE, pt.size = 1)
#DimPlot(pbmc, reduction = "tsne", group.by = "Phase", label=TRUE, pt.size = 1)
DimPlot(pbmc, reduction = "tsne", group.by = "ident", label=TRUE, pt.size = 1)
#DimPlot(pbmc, reduction = "tsne", group.by = "Celltype1", label=TRUE, pt.size = 1)
...
#DimPlot(pbmc, reduction = "umap", group.by = "ident", label=TRUE, pt.size = 1)
#DimPlot(pbmc, reduction = "umap", group.by = "Celltype1", label=TRUE, pt.size = 1)
