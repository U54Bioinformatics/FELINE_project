...
#SBATCH --mem=100G
#SBATCH --time=8:00:00
#SBATCH --output=scRNA_Seurat_01cluster_integrate_RPCA_object_icell8.sh.%A_%a.stdout
...
if [ ! -e $sample\_$platform\_cell_metadata.UMAPcluster.txt ]; then
   ...
   if [ $platform == 'icell8' ]; then
      ...
      echo "RPCA integration"
      /home/jichen/software/BETSY/install/envs/scRNA/bin/Rscript scRNA_Seurat_01cluster_integrate_RPCA_object_icell8.R $sample $platform 0
