...
def short_anno_file(infile):
    ...
    header  = ['Cell.ID', 'orig.ident', 'nCount_RNA', 'nFeature_RNA', 'Sample', 'Celltype', 'Celltype_subtype', 'Infercnv_CNA']
...
def main():
    ...
    outfile = read_meta_with_cluster(args.meta_cluster, cluster_anno) 
    short_anno_file(outfile) 
