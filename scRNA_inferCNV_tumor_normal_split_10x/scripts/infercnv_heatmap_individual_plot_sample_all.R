...
#Genes to add
gene_list <- c("PDPN", "THY1", "VIM", "CDH1", "CDH2", "CD34", "CDH11", "PTPRC", "GNLY", "CD3E", "CD3D", "CD68", "CD14", "FCGR3A", "KRT19", "ESR1", "EPCAM", "MSLN", "KRT8", "KRT18", "ANKRD30A")
