...
if [ ! -e $patient\_CNA_infer_NoClust\.png ]; then
   ...
   infer_noclust="final"
   infer_clust="hmm"
   #plot 2 clusters using "hmm" to split tumor and normal
   ...
   ~/software/Miniconda2/miniconda2/envs/Infercnv_heatmap/bin/Rscript --max-ppsize=500000 infercnv_heatmap_individual_plot_sample_all.R $patient 0 9 $infer_clust
   #plot 2 clusters using "final" to double check "hmm" clusters
   ...
   ~/software/Miniconda2/miniconda2/envs/Infercnv_heatmap/bin/Rscript --max-ppsize=500000 infercnv_heatmap_individual_plot_sample_all_rank_by_HMM.R $patient 1 9 $infer_noclust
