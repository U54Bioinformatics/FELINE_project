...
if [ ! -e $patient\_HMM_infersubclone_k$K\.png ]; then
   ...
   infer_noclust="final"
   infer_clust="hmm"
   ~/software/Miniconda2/miniconda2/envs/Infercnv_heatmap/bin/Rscript infercnv_heatmap_individual_plot_sample_all_subclone.R $patient 0 $K $infer_clust
...
infer_noclust="final"
~/software/Miniconda2/miniconda2/envs/Infercnv_heatmap/bin/Rscript infercnv_heatmap_individual_plot_sample_all_subclone_rank_by_HMM.R $patient 1 $K $infer_noclust
