...
# I put all cell ranger results in these two folder. The size is folder is 5.8T and XXT.
# premRNA folder: FELINE_cellranger_premRNA, used to all scRNA analysis except RNA velocity
sbatch FELINE_cellranger_premRNA.sh
# mRNA folder: FELINE_cellranger_mRNA, used to estimate RNA velocity
sbatch FELINE_cellranger_mRNA.sh
...
ls FELINE_cellranger_mRNA/COH0*_cell_ranger/*.txt
ls -d FELINE_cellranger_mRNA/COH0*_cell_ranger/cell_ranger
