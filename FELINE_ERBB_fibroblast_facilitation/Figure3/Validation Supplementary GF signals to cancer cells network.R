...
p0 <- ggraph(createdLayout[] , aes(x= x, y= y , col= Day ) ) + 
  ...
  scale_edge_color_gradient2()
p0 + scale_edge_color_gradient2(low="white",high="black")
ggsave( file= "~/Dropbox/Cancer_pheno_evo/images and presentations/FELINE 2/Cancer GF analyses/Validation Supplementary GF signals to cancer cells network with text.pdf",width=10, height=10)
