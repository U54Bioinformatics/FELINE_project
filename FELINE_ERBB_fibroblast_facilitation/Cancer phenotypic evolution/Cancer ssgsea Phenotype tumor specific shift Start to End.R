...
u_dattrim <- data.table( u_dat[Celltype=="Cancer cells"][Day %in% c(0, 180)] %>% dplyr::select(c(Cell.ID:V5, one_of(common_ssgsea))) )
...
ordplt
write.csv(ordplt,  file="/Users/jason/Dropbox/Cancer_pheno_evo/data/FELINE2/Gene expression landscapes/cancer gene expression landscape/ERBB ssGSEA pathways  shift during Endocrine therapy in cancer names.csv")
