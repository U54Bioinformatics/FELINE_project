...
#SBATCH --output=run_maftools.patient.sh.%A_%a.stdout
#SBATCH -p fast,all
#SBATCH --workdir=./
...
# prefix for output
prefix=FELINE_patient
# gene cnv FACETS, WES
gene_cnv=FELINE_FACETS_copy_number_gene.cnv4maftools.patient.txt
# maf
maf=FELINE.vep.patient.maf
# clinic
clinical=FELINE.clinical.patient.txt
