...
dd <- data.table( read.csv(file=paste0(savloc,"SourceData_Figure6_TcellMonocultureDrugImpact.csv")))
dd[,RepID:=1:nrow(dd)]
...
resout<-ATPdat
write.csv(resout,file=paste0(savloc,"Outputs/","SourceData_Figure6_ATP_vs_riboIL15_Out.csv"))
...
resout<-inputdata[Hour==max(Hour)]
write.csv(resout,file=paste0(savloc,"Outputs/","SourceData_Figure6_Area_vs_riboIL15_Out.csv"))
