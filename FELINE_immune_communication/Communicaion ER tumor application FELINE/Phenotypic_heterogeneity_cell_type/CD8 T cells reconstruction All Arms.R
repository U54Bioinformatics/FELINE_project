...
# Checks
#SSGSEA[Gene_Set=="ABBUD_LIF_SIGNALING_1_DN"][,FEL011_M_CAGAGCCGTTCTATCT]
#all_1[Gene_Set=="ABBUD_LIF_SIGNALING_1_DN"][,FEL011_M_CAGAGCCGTTCTATCT]
#allgene_dd_transp["FEL011_M_CAGAGCCGTTCTATCT","ABBUD_LIF_SIGNALING_1_DN"]
#full_dd_transp["FEL011_M_CAGAGCCGTTCTATCT","ABBUD_LIF_SIGNALING_1_DN"]
#ss_dd["FEL011_M_CAGAGCCGTTCTATCT","ABBUD_LIF_SIGNALING_1_DN"]
