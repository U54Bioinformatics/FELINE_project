...
# Checks
#SSGSEA[Gene_Set=="ABBUD_LIF_SIGNALING_1_DN"][,FEL011_M_AACACACTCTACTGAG]
#all_1[Gene_Set=="ABBUD_LIF_SIGNALING_1_DN"][,FEL011_M_AACACACTCTACTGAG]
#allgene_dd_transp["FEL011_M_AACACACTCTACTGAG","ABBUD_LIF_SIGNALING_1_DN"]
#full_dd_transp["FEL011_M_AACACACTCTACTGAG","ABBUD_LIF_SIGNALING_1_DN"]
#ss_dd["FEL011_M_AACACACTCTACTGAG","ABBUD_LIF_SIGNALING_1_DN"]
...
u_dat[Cell.ID=="FEL011_M_AACACACTCTACTGAG","ABBUD_LIF_SIGNALING_1_DN"]
# merge(metadd[Day%in%DAY], data.table(Cell.ID=rownames(ss_dd),umap_data_tt$layout,pc_rot , ss_dd) ,by="Cell.ID")
methodcor= "spearman"

corVall <-cor(u_dat[]%>%dplyr::select(paste0("V",1:NN)),u_dat[]%>%dplyr::select(colnames(ss_dd)),method=methodcor)
