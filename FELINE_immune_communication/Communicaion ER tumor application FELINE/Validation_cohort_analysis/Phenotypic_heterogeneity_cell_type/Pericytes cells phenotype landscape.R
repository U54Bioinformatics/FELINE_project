...
cell_types_all <-c("Pericytes");   #### CHANGE HERE compdataLU
...
ggplot(u_dat[ARM!="A"][abs(V1)<2],aes(V1,V2,col=Quality))+theme_classic()+geom_point(size=1.5,alpha=0.5)#+facet_grid(Day~dynamic_class3)
