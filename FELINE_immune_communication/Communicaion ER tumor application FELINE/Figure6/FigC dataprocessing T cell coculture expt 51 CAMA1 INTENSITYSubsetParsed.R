...
# Load the data
dd <- data.table( read.csv(file="/Users/jason/Jason Griffiths Dropbox/jason griffiths/R Analysis/Cancer_Tcell_Experiments/Exp51/RawDataQC_PC/EXP51_SubsetYFPThreshold_CAMA1/Exp51_Plate142-151_CAMA1_INTENSITYSubsetParsed_V2.csv"))
dd[,RepID:=1:nrow(dd)]
...
getCountModels <- function(){
  # Load the data
  dd <- data.table( read.csv(file="~/Dropbox/Cancer_pheno_evo/data/Lab Fibroblast/FengCellNumberIntensities_Parsed_Clean.csv") )
...
expt51dd <- inputdd#[TCellPrep != "Stained"][][][IL15_ngmL%in%c(0,1,5)]
#save(expt51dd,file="/Users/jason/Jason Griffiths Dropbox/jason griffiths/R Analysis/Cancer_Tcell_Experiments/Exp51/Modeling_JG/data/INTENSITYSubsetParsedprocessed_data.RData")
load(file="/Users/jason/Jason Griffiths Dropbox/jason griffiths/R Analysis/Cancer_Tcell_Experiments/Exp51/Modeling_JG/data/INTENSITYSubsetParsedprocessed_data.RData")
